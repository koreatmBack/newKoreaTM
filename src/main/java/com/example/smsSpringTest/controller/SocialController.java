...
//        url.append("&redirect_uri=http://localhost:8080/v1/jobsite/user/naver/integ");
        url.append("&redirect_uri=https://cafecon.co.kr/v1/jobsite/user/naver/integ");
        url.append("&response_type=code");
        return "redirect:"+url.toString();
    }
...
//        url.append("&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fv1%2Fjobsite%2Fuser%2Fgoogle%2Finteg");
        url.append("&redirect_uri=https%3A%2F%2Fcafecon.co.kr%2Fv1%2Fjobsite%2Fuser%2Fgoogle%2Finteg");
        url.append("&response_type=code");
        url.append("&scope=email profile");
        return "redirect:"+url.toString();
    }
...
//        url.append("&scope=email profile");
    ...
    public String facebookInteg(){
        ...
        url.append("https://www.facebook.com/v15.0/dialog/oauth?");
        url.append("client_id="+facebookClientId);
        url.append("&redirect_uri=https%3A%2F%2Fcafecon.co.kr%2Fv1%2Fjobsite%2Fuser%2Ffacebook%2Finteg");
        url.append("&response_type=code");
//        url.append("&scope=email profile");
        return "redirect:"+url.toString();
    }
